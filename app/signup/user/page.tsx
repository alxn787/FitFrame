...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="flex w-full max-w-5xl shadow-lg rounded-3xl">
        ...
        <div className="w-full md:w-1/2 bg-white p-8 rounded-3xl md:rounded-l-none">
          ...
          <h1 className="text-3xl font-bold mb-6">Ready to Show your Skills ?</h1>
            <h1 className="text-2xl font-bold mb-6">Log in </h1>

            {/* Social login buttons */}
            <button className="w-full mb-4 border border-gray-300 rounded-lg py-2 px-4 flex items-center justify-center space-x-2 hover:bg-gray-50 transition-colors duration-200">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent flex flex-col items-center justify-center"
                />
                <button 
                  type="button"
